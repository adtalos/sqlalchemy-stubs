...
class Connection(Connectable):
    ...
    def close(self) -> None: ...
    def scalar(self, object, *multiparams: Any, **params: Any): ...
    def execute(self, object: Union[Text, ClauseElement, FunctionElement[Any], DDLElement, DefaultGenerator, Compiled], *multiparams: Any, **params: Any) -> ResultProxy: ...
...
class Engine(Connectable, log.Identified):
    ...
    def run_callable(self, callable_, *args, **kwargs: Any): ...
    def execute(self,
                object: Union[Text, ClauseElement, FunctionElement[Any], DDLElement, DefaultGenerator, Compiled],
                *multiparams: Any,
                **params: Any) -> ResultProxy: ...
    def scalar(self, statement, *multiparams: Any, **params: Any): ...
