...
class Query(Generic[_T]):
    ...
    def execution_options(self, **kwargs: Any): ...
    def with_lockmode(self, mode): ...
    def with_for_update(self: _Q, read: bool = ..., nowait: bool = ..., of: Optional[Any] = ...,
                        skip_locked: bool = ..., key_share: bool = ...) -> _Q: ...
    def params(self: _Q, *args: Any, **kwargs: Any) -> _Q: ...
    def filter(self: _Q, *criterion: Any) -> _Q: ...
    def filter_by(self: _Q, **kwargs: Any) -> _Q: ...
    def order_by(self: _Q, *criterion: Any) -> _Q: ...
    def group_by(self: _Q, *criterion: Any) -> _Q: ...
    def having(self: _Q, criterion: Any) -> _Q: ...
    def union(self, *q): ...
    ...
    def join(self, *props, **kwargs: Any): ...
    def outerjoin(self, *props, **kwargs: Any): ...
    ...
    def distinct(self, *criterion: Any): ...
    ...
    def update(self, values: Dict[str, Any], synchronize_session: Union[bool, str] = ..., update_args: Optional[Any] = ...) -> int: ...
