...
class Session(_SessionClassMethods):
    ...
    @overload
    def query(self, entity: Type[_T], **kwargs: Any) -> Query[_T]: ...
    @overload
    def query(self, entity: Column[_T], **kwargs: Any) -> Query[Tuple[_T]]: ...
    @overload
    def query(self, *entities: Any, **kwargs: Any) -> Query[Any]: ...  # plugin is needed for precise type
    @property
    ...
    def bulk_save_objects(self, objects: List[Any], return_defaults: bool = ..., update_changed_only: bool = ...) -> None: ...
